...
FIXTURE_HTML = """
<table>
  <tr class="notice"><td><a class="subject" href="/notice">공지</a></td></tr>
  <tr class="table_body" data-category="유머" data-published-at="2026-07-15 09:00" data-views="4,521" data-comments="37" data-likes="120">
    <td class="subject"><a class="deco" href="/best/humor/read/1001">첫 번째 샘플</a></td>
  </tr>
  <tr class="table_body" data-category="정보" data-published-at="2026-07-15 09:05" data-views="310">
    <td class="subject"><a class="deco" href="/best/humor/read/1002">두 번째 샘플</a></td>
  </tr>
</table>
"""
...
DEDUP_FIXTURE_HTML = """
<table>
  <tr data-views="10"><td><a class="deco" href="/best/humor/read/1">URL 중복</a></td></tr>
  <tr data-views="20"><td><a class="deco" href="/best/humor/read/1">다른 제목</a></td></tr>
  <tr data-views="30"><td><a class="deco" href="/best/humor/read/2">제목 중복</a></td></tr>
  <tr data-views="40"><td><a class="deco" href="/best/humor/read/3">제목 중복</a></td></tr>
</table>
"""


class TestRuliwebCollector(unittest.TestCase):
    def setUp(self):
        self.tmp = Path("storage") / "_tmp_ruliweb_collector"
        self.tmp.mkdir(parents=True, exist_ok=True)
        self.cache_path = self.tmp / "ruliweb_cache.json"
        self.source = {
            "source_id": "ruliweb",
            "name": "Ruliweb",
    ...
    def test_parses_visible_fixture_fields_without_network(self):
        ...
        self.assertEqual(
            items[0]["link"], "https://bbs.ruliweb.com/best/humor/read/1001"
        )
        self.assertEqual(items[0]["views"], 4521)
        self.assertEqual(items[0]["comments"], 37)
        self.assertEqual(items[0]["likes"], 120)
        self.assertEqual(items[0]["category"], "유머")
        self.assertEqual(items[0]["published_at"], "2026-07-15 09:00")
        self.assertEqual(items[0]["rank_position"], 1)
        self.assertIsNone(items[1]["comments"])
        self.assertIsNone(items[1]["likes"])
        self.assertEqual(
            collector.last_status["collection_method"], "ruliweb_fixture_html"
        )
    ...
    def test_default_activation_is_fail_closed(self):
        ...
        self.assertEqual(
            ...
            RuliwebCollector.LIVE_REJECTION_REASON,
        )
    ...
    def test_valid_cache_is_used_after_injected_fixture_failure(self):
            ...
            "items": [
                {
                    "keyword": "캐시 샘플",
                    "title": "캐시 샘플",
                    "link": "https://bbs.ruliweb.com/best/humor/read/9",
                    "url": "https://bbs.ruliweb.com/best/humor/read/9",
                    "rank_position": 1,
                    "views": 9,
                }
            ],
        ...
        self.assertEqual(items[0]["collection_method"], "ruliweb_cache")
    ...
    def test_no_default_or_operational_cache_leakage(self):
        default_path = RuliwebCollector.DEFAULT_CACHE_PATH
