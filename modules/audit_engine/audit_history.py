...
class AuditHistory(object):
    """
    Content Audit Engine - History.

    storage/audit/audit_history.json에 실행별 audit_score/checks 요약을 append-only로
    기록한다.
    """
    ...
    def __init__(self, history_path: Optional[Path] = None):
        self.history_path = history_path or Path("storage/audit/audit_history.json")
    ...
    def record(self, result: Dict[str, Any]) -> None:
        try:
            ...
            print(f"Audit History Write Failed: {error}")
